...
const Dashboard = () => {
	...
	const activities = [
		{
			text: "Completed comprehensive health assessment",
			time: "2 hours ago",
			type: "success",
		},
		{
			text: "Uploaded lab report for blood work",
			time: "1 day ago",
			type: "info",
		},
		{
			text: "Started new chat session with AI assistant",
			time: "2 days ago",
			type: "primary",
		},
		{
			text: "Downloaded health report PDF",
			time: "3 days ago",
			type: "secondary",
		},
	];
	...
	const quickActions = [
		{
			name: "Start Health Chat",
			icon: MessageSquare,
			description: "Begin AI-powered health assessment",
		},
		{
		...
		},
		{
			name: "View Reports",
			icon: Activity,
			description: "Access your health analytics",
		},
		{
		...
		<div className="min-h-screen relative">
					...
					<div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 animate-fadeIn">
						<div className="space-y-4">
							...
							<p className="text-xl text-indigo-100 font-light max-w-lg">
								Your personalized health dashboard is ready. Track your wellness
			...
			<div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 -mt-20 relative z-10 pb-16 space-y-10">
				...
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
					{/* Activity Feed */}
					<div
						className="lg:col-span-8 animate-fadeIn"
					...
					>
						<div className="bg-white rounded-3xl p-8 lg:p-10 premium-shadow h-full border border-slate-100/80 relative overflow-hidden">
							...
							<div className="flex items-center justify-between mb-8 relative z-10">
								<div>
									<h2 className="text-2xl lg:text-3xl font-serif text-slate-900">
										Recent Activity
									</h2>
					...
					<div
						className="lg:col-span-4 space-y-6 animate-fadeIn"
						style={{ animationDelay: "300ms" }}
					>
						{/* Quick Actions */}
						<div className="bg-white rounded-3xl p-6 lg:p-8 premium-shadow border border-slate-100/80">
							<h2 className="text-xl lg:text-2xl font-serif text-slate-900 mb-6">
								Quick Actions
							</h2>
						...
						<div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500 via-slate-100 to-blue-300 p-6 lg:p-8 shadow-2xl text-black group">
							<div className="absolute top-0 right-0 w-48 h-48 bg-indigo-100/20 rounded-full blur-3xl -mr-16 -mt-16 group-hover:bg-indigo-500/30 transition-all duration-700"></div>
							...
							<div className="relative z-10">
								...
								<h3 className="text-2xl font-serif mb-3 text-indigo-900">
									AI Insights
								</h3>
								<p className="text-indigo-900 font-light leading-relaxed mb-6 text-sm lg:text-base">
									Your cardiovascular trends are looking great this week. Keep
									up the excellent work!
								</p>
								<button className="w-full bg-white/10 hover:bg-white/20 backdrop-blur-sm text-indigo-900 font-medium py-3 px-6 rounded-xl transition-all border border-white/10 hover:border-white/20 flex items-center justify-center gap-2 group/btn">
